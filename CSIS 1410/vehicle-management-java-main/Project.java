...
public class Project {
	...
	private void initialize() {
		...
		lblVehicleManagementSystem.setForeground(Color.GREEN);
		...
		btnAdmin.setBounds(50, 122, 145, 50); 
		...
		btnDealer.setBounds(265, 122, 145, 50);
		...
		btnVehicles.setBounds(475, 122, 145, 50);
		...
		btnAdminLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(uname.equals("admin") && pass.equals("admin")) {
					...
					comboBox.setModel(new DefaultComboBoxModel<String>(new String[] {"", "Dealer","Vehicle"}));
		...
		btnDLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(d.loginDealer(uname,pass,vh)) {
					...
					btnManageVehicles.setBounds(248, 122, 200, 50);
					dealermenupanel.add(btnManageVehicles);
					
					
					JButton btnMyAccount = new JButton("MY ACCOUNT"); 
					btnMyAccount.setBounds(248, 172, 200, 50);
		...
		comboBoxDNRegion.setModel(new DefaultComboBoxModel<String>(new String[] {"","Salt Lake", "West Valley city", "Magna", "Kearns","Murray", "Draper", "Lehi","Ogden", "Provo"}));
